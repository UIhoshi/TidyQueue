...
- `npm test` uses Node's test runner for queue transitions, route/hidden-tab safety guards, conversation-link/time-group helpers, locale-catalog completeness, and fallback substitutions.
