...
openButton.addEventListener('click', async () => {
  ...
  if (!tab?.id || !/^https:\/\/(chatgpt\.com|chat\.openai\.com)\//.test(tab.url || '') && !/^https:\/\/gemini\.google\.com\/app(?:[/?#]|$)/.test(tab.url || '') && !/^https:\/\/(copilot\.com|copilot\.microsoft\.com|perplexity\.ai|www\.perplexity\.ai|kimi\.com|www\.kimi\.com)(?:[/?#]|$)/.test(tab.url || '')) {
