...
const requiredFiles = ['src/popup/popup.html', 'src/popup/popup.js', 'src/content/content.js', 'src/content/queue-controller.js', 'src/content/conversation-adapter.js', 'assets/tidyqueue-icon-128.png'];
