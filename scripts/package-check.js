...
const requiredFiles = ['src/popup/popup.html', 'src/popup/popup.js', 'src/content/content.js', 'src/content/cleanup-session.js', 'src/content/queue-controller.js', 'src/content/queue-safety-guard.js', 'src/content/conversation-adapter.js', 'src/content/gemini-adapter.js', 'src/content/claude-adapter.js', 'src/content/copilot-adapter.js', 'src/content/perplexity-adapter.js', 'src/content/kimi-adapter.js', 'src/content/provider-adapter.js', 'assets/tidyqueue-icon-128.png'];
...
for (const host of ['https://chatgpt.com/*', 'https://chat.openai.com/*', 'https://gemini.google.com/app*', 'https://claude.ai/*', 'https://copilot.com/*', 'https://copilot.microsoft.com/*', 'https://perplexity.ai/*', 'https://www.perplexity.ai/*', 'https://kimi.com/*', 'https://www.kimi.com/*']) if (!matches.includes(host)) throw new Error(`Missing host match: ${host}`);
