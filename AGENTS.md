...
- Product: a Chrome Manifest V3 extension that helps a user review and delete their own ChatGPT, Gemini, Copilot, Perplexity, or Kimi conversations from a visible tab.
